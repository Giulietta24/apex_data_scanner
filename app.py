...
if submit_audit and custom_symbol_input:
    ...
    with st.spinner(f"Querying encrypted arrays for {custom_symbol_input}..."):
        ...
        if hist.empty or len(hist) < 20:
            ...
            st.caption(f"🌍 Broad Market Status Indicator: Equal-Weighted S&P 500 (RSP) is {'🟢 BULLISH / PARTICIPATING' if rsp_confirmed_bullish else '🔴 BEARISH / DIVERGENT'}")
            ...
            with st.spinner("Executing optimized vectorized computation matrices..."):
                try:
                    ...
                    if combined_df.empty:
                        ...
                        # High-Speed Native Vectorization Comparisons Instead of Standard Matrix Loop
